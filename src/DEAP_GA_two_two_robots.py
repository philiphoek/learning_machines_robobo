...
def simulation(controller, robot):
    ...
    for i in range(allowed_steps):
        ...
        if controller.top_left_two == 1 or controller.top_right_two == 1:
            reward_for_seeing_object += 0.5

        if controller.bottom_left_two == 1 or controller.bottom_right_two == 1 or controller.top_center_two == 1:
            reward_for_seeing_object += 1

        if controller.bottom_center_two == 1:
            reward_for_seeing_object += 1.5
